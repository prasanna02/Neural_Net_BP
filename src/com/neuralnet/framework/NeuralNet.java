...
public class NeuralNet implements NeuralNetInterface {
    ...
    public double outputFor(double[] inputVector) {
        ...
        /**
        System.out.println(inducedLocalHidden[0]);
        System.out.println(inducedLocalHidden[1]);
        System.out.println(inducedLocalHidden[2]);
        System.out.println(inducedLocalHidden[3]);
        System.out.println(activatedHidden[0]);
        System.out.println(activatedHidden[1]);
        System.out.println(activatedHidden[2]);
        System.out.println(activatedHidden[3]);
        */
    ...
    public void updateWeightsH2O() {
        ...
        for (int i = 0; i < numHidden; i++) {
            ...
            //System.out.println(activatedHidden[i]);
            //System.out.println(momentumTerm);
            //System.out.println(deltaWeightsH2O(i));
            //System.out.println(weightsH2O[i]);
    ...
    /**
     * Train the NN or the LUT the outpu value that should be mapped to the given input vector.
    ...
    /**
     * Save the weights of a neural net to a file to be loaded later when needed.
